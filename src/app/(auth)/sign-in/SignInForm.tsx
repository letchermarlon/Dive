...
export default function SignInForm() {
  ...
  return (
    <div className={cn('flex flex-col gap-6 bg-black/80 backdrop-blur-md border border-white/10 rounded-2xl p-8 shadow-2xl')}>
      ...
      {sent ? (
        ...
        <form onSubmit={handleEmail} className="flex flex-col gap-4">
          ...
          <Button type="submit" disabled={loading} className="w-full bg-cyan-500 hover:bg-cyan-400 text-black font-medium">
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        <Button variant="outline" type="button" onClick={handleApple}
      ...
      <p className="text-center text-xs text-white/30">
        ...
        <a href="#" className="underline underline-offset-4 hover:text-white/60">Terms</a>{' '}
        and{' '}
        <a href="#" className="underline underline-offset-4 hover:text-white/60">Privacy Policy</a>.
      </p>
    </div>
  )
}
